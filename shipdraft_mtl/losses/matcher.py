# ------------------------------------------------------------------------
# DraftFormer Hungarian Matcher
# ------------------------------------------------------------------------
# Computes matching cost and solves the Linear Sum Assignment Problem (LSAP)
# for bipartite matching between predictions and ground truth.
#
# Historical Note:
#   Originally derived from DINO/MaskDINO (IDEA, 2022).
# ------------------------------------------------------------------------
...
from shipdraft_mtl.losses.point_sampling import point_sample
from shipdraft_mtl.utils.box_ops import generalized_box_iou,box_cxcywh_to_xyxy
